...
public class MyJob implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        // 取出JobDataMap的值（如果jobDetailMap/triggerMap里面的key相同，则最新的会覆盖旧的）
        System.out.println("jobDetailMap value = "+jobDetailMap.getString("job-detail-data-key"));
        System.out.println("triggerMap value = "+triggerMap.getString("trigger-data-key"));
